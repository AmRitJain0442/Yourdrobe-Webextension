...
export function YouCamConsent({ busy, error, onAccept, onCancel }: Props) {
  ...
  return <section aria-busy={busy}>
    ...
    <p>Perfect Corp may retain uploaded and generated assets for up to 30 days. The generated download URL is temporary. Unless you choose Use as active outfit, Yourdrobe keeps the preview only in this side-panel session. An active outfit is stored browser-locally and uploaded to Perfect Corp when you use it for another live preview.</p>
