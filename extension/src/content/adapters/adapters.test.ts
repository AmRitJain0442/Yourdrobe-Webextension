...
const cases = [
  {
    ...
    platform: "amazon_in", currency: "INR", price: 1799, category: "apparel", url: "https://www.amazon.in/dp/IN1",
  },
  {
    host: "www.amazon.com",
    ...
    platform: "amazon_us", currency: "USD", price: 29.99, category: "apparel", url: "https://www.amazon.com/dp/US1",
  },
  {
    ...
    platform: "flipkart", currency: "INR", price: 1499, category: "apparel", url: "https://www.flipkart.com/red-shirt/p/FK1",
  },
  {
    host: "www.nykaa.com",
    ...
    platform: "nykaa", currency: "INR", price: 799, category: "makeup", url: "https://www.nykaa.com/red-lipstick/p/NY1",
  },
] as const;
...
describe("commerce adapters", () => {
  for (const item of cases) {
    it(`extracts ${item.host}`, () => {
      ...
      expect(products[0]).toMatchObject({ platform: item.platform, currency: item.currency, price: item.price, category: item.category, product_url: item.url });
